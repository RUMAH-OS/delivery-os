...
| 2 | **Wiki** | reusable knowledge: architecture, decisions, lifecycles-as-principle, operating principles, playbooks, traps/why/rollback. **Includes the *Capability Reference* generation-class** (a contract-generated "how to consume" KU — `wiki/cap-ref-<id>-<version>/KU.md`; routable like any KU, NOT a new bucket — see `CAPABILITY-PROMOTION-DISCOVERY.md §B`, KNOW-6). | **KU** (`KU.md` + frontmatter contract) | `delivery-os/wiki/<kuId>/KU.md` | `knowledge-route` (PRESENT) |
